...
E.g. creating and pushing a new `2026.06` tag in this repository will automatically build `portainer/dev-toolkit:2026.06`.
...
Then you can use the instructions above to run it, just replace the official `portainer/dev-toolkit:2026.06` with your image in the `devcontainer.json` file:

...
E.g. creating and pushing a new `2025.01` tag in this repository will automatically build `portainer/dev-toolkit:2025.01`.
...
Then you can use the instructions above to run it, just replace the official `portainer/dev-toolkit:2025.01` with your image in the `devcontainer.json` file:
